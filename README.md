...
|---|--------|------------------------|
| 1 | Singleton | `ConfiguracaoRestaurante` |
| 2 | Abstract Factory | `FabricaDeIngredientes`, `FabricaTradicional`, `FabricaVegana`, `FabricaGourmet` |
| 3 | Flyweight | `RepositorioIngredientes`, `IngredienteImpl` |
| 4 | Builder | `LancheBuilder`, `LancheBuilderImpl`, `Lanche` |
| 5 | Prototype | `CardapioFolha.clone()` |
| 6 | Factory Method | `FabricaDePedido`, `FabricaPedidoBalcao/Mesa/Delivery` |

### Estruturais
| # | Padrão | Classe(s) Principal(is) |
|---|--------|------------------------|
| 7 | Composite | `ItemCardapio`, `CardapioFolha`, `CardapioCategoria` |
| 8 | Decorator | `DecoradorItemCardapio`, `DecoradorBacon/QueijoExtra/MolhoEspecial` |
| 9 | Adapter | `MetodoPagamento`, `AdaptadorPix/Cartao/Dinheiro` |
| 10 | Bridge | `RelatorioPedido`, `FormatoSaida`, `SaidaTerminal`, `SaidaCupom` |
| 11 | Proxy | `EstoqueProxy`, `ProxyEstoque`, `GerenciadorEstoque` |
| 12 | Facade | `SistemaRestaurante` |

### Comportamentais
| # | Padrão | Classe(s) Principal(is) |
|---|--------|------------------------|
| 13 | State | `EstadoPedido`, `EstadoNovo/Pago/Preparando/Pronto/Entregue/Cancelado` |
| 14 | Observer | `ObservadorPedido`, `NotificacaoCliente/Cozinha/Atendente` |
| 15 | Command | `ComandoPedido`, `GerenciadorComandos` |
| 16 | Memento | `PedidoMemento`, `HistoricoPedido` |
| 17 | Chain of Responsibility | `ManipuladorPedido`, `ValidadorItens/Estoque/Pagamento`, `ProcessadorCozinha` |
| 18 | Strategy | `EstrategiaDesconto`, `DescontoFidelidade/HorarioPico/Progressivo` |
| 19 | Template Method | `PreparacaoLanche`, `PreparacaoTradicional/Vegana/Gourmet` |
| 20 | Iterator | `IteradorCardapio` |
| 21 | Visitor | `Visitante`, `RelatorioPrecos`, `RelatorioVegano` |
| 22 | Mediator | `CozinhaMediator`, `CentralCozinha`, `ColaboradorCozinha` |
| 23 | Interpreter | `InterpretadorPedido`, `ExpressaoPersonalizacao` |